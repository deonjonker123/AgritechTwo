...
public class Config {
    ...
    private static void fertilizerConfig() {
        ...
        FERTILIZER_BIOMASS_SPEED_MULTIPLIER               = COMMON_BUILDER.comment("Speed multiplier for Biomass").defineInRange("biomass_speed_multiplier", 1.3D, 0.1D, 10.0D);
        FERTILIZER_BIOMASS_YIELD_MULTIPLIER               = COMMON_BUILDER.comment("Yield multiplier for Biomass").defineInRange("biomass_yield_multiplier", 1.3D, 0.1D, 10.0D);
        FERTILIZER_COMPACTED_BIOMASS_SPEED_MULTIPLIER     = COMMON_BUILDER.comment("Speed multiplier for Compacted Biomass").defineInRange("compacted_biomass_speed_multiplier", 1.8D, 0.1D, 10.0D);
        FERTILIZER_COMPACTED_BIOMASS_YIELD_MULTIPLIER     = COMMON_BUILDER.comment("Yield multiplier for Compacted Biomass").defineInRange("compacted_biomass_yield_multiplier", 1.8D, 0.1D, 10.0D);
