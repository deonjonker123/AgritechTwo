...
public class ATDataMaps {
    public static final DataMapType<Item, FertilizerData> FERTILIZERS = DataMapType
            .builder(ResourceLocation.fromNamespaceAndPath(AgritechTwo.MODID, "fertilizers"), Registries.ITEM, FertilizerData.CODEC)
            .synced(FertilizerData.CODEC, false)
            .build();

    public static final DataMapType<Item, SoilModifierData> SOIL_MODIFIERS = DataMapType
            .builder(ResourceLocation.fromNamespaceAndPath(AgritechTwo.MODID, "soil_modifiers"), Registries.ITEM, SoilModifierData.CODEC)
